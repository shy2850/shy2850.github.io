...
define("containers/ArticleListOfTag", ["require", "exports", "react", "../components/Box", "../components/Pager", "../config"], function (require, exports, React, Box_1, Pager_1, config) {
    "use strict";
    ...
    var List = /** @class */ (function (_super) {
        ...
        List.prototype.filterArticles = function () {
            ...
            return articles.filter(function (article) { return ~article.keywords.indexOf(tag); });
        };
        ...
        List.prototype.render = function () {
            ...
            return list.length ? React.createElement("div", null,
                ...
                React.createElement(Pager_1["default"], { current: page, size: size, total: list.length, onChange: this.changePage.bind(this) })) : React.createElement("h2", { style: { textAlign: 'center' } }, "\u8BE5\u6807\u7B7E\u8FD8\u6CA1\u6709\u6587\u7AE0\uFF01");
        };
        return List;
    }(React.Component));
